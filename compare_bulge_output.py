...
filename1=int(sys.argv[1])
filename2=int(sys.argv[2])
...
hist_bulges_2, bin_edges = np.histogram(np.log10(gals_bulges_2['BlackHoleMass']*1e10),range=(minval,maxval))
...
ax1.plot(bin_edges[:-1],hist_bulges_2/(bin_edges[1]-bin_edges[0])/100**3,'--',label='Bulges (Density dependent SF)')
...
hist_bulges_2, bin_edges = np.histogram(np.log10(gals_bulges_2[prop]*1e10),range=(minval,maxval))
ax2.plot(bin_edges[:-1],hist_default/(bin_edges[1]-bin_edges[0])/100**3,label='Default')
ax2.plot(bin_edges[:-1],hist_bulges/(bin_edges[1]-bin_edges[0])/100**3,'--',label=filename1)
ax2.plot(bin_edges[:-1],hist_bulges_2/(bin_edges[1]-bin_edges[0])/100**3,'--',label='filename2')
...
ax3.plot(bin_edges[:-1],hist_bulges_2/(bin_edges[1]-bin_edges[0])/100**3,'--',label='Bulges (Density dependent SF)')
...
hist_bulges_2, bin_edges = np.histogram(np.log10(gals_bulges_2[prop]*1e10),range=(minval,maxval))
hist_disks_2, bin_edges = np.histogram(np.log10(gals_bulges_2['StellarMass']*1e10-gals_bulges_2[prop]*1e10),range=(minval,maxval))
...
ax4.plot(bin_edges[:-1],hist_bulges_2/(bin_edges[1]-bin_edges[0])/100**3,'b--',label='Bulges (Density Dependent SF)')
ax4.plot(bin_edges[:-1],hist_disks_2/(bin_edges[1]-bin_edges[0])/100**3,'g-',label='Disks (Density Dependent SF)')
