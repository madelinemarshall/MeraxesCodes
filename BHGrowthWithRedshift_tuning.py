...
def plot_obs(axes):
  ...
  axes.errorbar(np.log10(1+X),Y,yerr=[Y_low,Y_up],xerr=[np.log10(1+X_low),np.log10(1+X_up)])
...
if __name__=="__main__":
  ...
  plt.savefig('/home/mmarshal/results/plots/tuning_paper2/Tiamat/BHGrowth_{}.pdf'.format(int(meraxes_loc[-8:-5])),format='pdf')
  plt.show()
