...
def fit_parameters(x,y,mass_bulge,snap):
    ...
    x=x[elements]
    y=y[elements]
    fit,err=_polyfit_bootstrap(x,y,1,sigma=[], num_samples = 1000, alpha=0.68, asymmetric=False)
...
if __name__=='__main__':
  ...
  snapshots=[100,116,134,158]
  prop='StellarMass'
  color={100:'#a65628',116:'#e41a1c',134:'#377eb8',100:'#4daf4a',158:'#f781bf',194:'#a65628',250:'black'}
