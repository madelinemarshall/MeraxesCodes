...
if __name__=="__main__":
  ...
  filename2='high_seed'#'tuned_reion_T125'
  filenameMR='tuned_T125_MR'
  filenameNR='tuned_T125_NR'
  ...
  plt.tight_layout()
  fig.savefig('/home/mmarshal/results/plots/MeanBHBulge_resolutionTest.pdf', format='pdf',bbox_extra_artists=(lgd,), bbox_inches='tight')
  plt.show()
