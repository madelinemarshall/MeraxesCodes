...
if __name__=='__main__':
  ...
  plt.tight_layout()
  if plot_type==1:
    plt.savefig('/home/mmarshal/results/plots/Paper1/MBHMStellarRelation_z0.pdf', format='pdf')
  else:
    plt.savefig('/home/mmarshal/results/plots/Paper1/MBHMStellarRelation_BulgeType_z0.pdf', format='pdf')
  plt.show()
