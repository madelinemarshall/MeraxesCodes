...
def _h_convertor_x(hubble_h_obs,hubble_h=0.678):
    return -2. * np.log10(hubble_h/hubble_h_obs)

def _h_convertor_y(hubble_h_obs,hubble_h=0.678):
    return 3. * np.log10(hubble_h/hubble_h_obs)

def plot_obsGSMF_z7pt0(ax,hubble_h=0.678,markersize=10,legend=True,color='gray',alpha=1.0):
    ...
    if legend:
        ax.errorbar(data[:,0]+_h_convertor_x(0.69999999,hubble_h),\
                    ...
                    yerr=[data[:,2],data[:,3]],\
                    markersize=markersize,fmt='s',color=color,label='Gonzalez et al. 2011')
    else:
        ax.errorbar(data[:,0]+_h_convertor_x(0.69999999,hubble_h),\
                    data[:,1]+_h_convertor_y(0.69999999,hubble_h),\
                    yerr=[data[:,2],data[:,3]],\
                    markersize=markersize,fmt='s',color=color)
    ...
    if legend:
        ax.errorbar(data[:,0]+_h_convertor_x(0.7,hubble_h)+np.log10(Cha2Sal),\
                    ...
                    markersize=markersize,fmt='o',color=color,label='Duncan et al. 2014')
    else:
        ax.errorbar(data[:,0]+_h_convertor_x(0.7,hubble_h)+np.log10(Cha2Sal),\
                    np.log10(data[:,1])+_h_convertor_y(0.7,hubble_h),\
                    yerr=[np.log10(data[:,1])-np.log10(data[:,1]-data[:,2]),\
                          np.log10(data[:,1]+data[:,3])-np.log10(data[:,1])],\
                    markersize=markersize,fmt='o',color=color)
    ...
    if legend:
        ax.errorbar(data[:,0]+_h_convertor_x(0.7,hubble_h),\
                    data[:,1]+_h_convertor_y(0.7,hubble_h),\
                    yerr=[data[:,2],data[:,3]],\
                    markersize=markersize,fmt='D',color=color,label='Song et al. 2015')
    else:
        ax.errorbar(data[:,0]+_h_convertor_x(0.7,hubble_h),\
                    data[:,1]+_h_convertor_y(0.7,hubble_h),\
                    yerr=[data[:,2],data[:,3]],\
                    markersize=markersize,fmt='D',color=color)
    ...
    if legend:
        ax.errorbar(data[:,0]+_h_convertor_x(0.7,hubble_h),\
                    ...
                    markersize=markersize,fmt='^',color=color,label='Grazian et al. 2015')
    else:
        ax.errorbar(data[:,0]+_h_convertor_x(0.7,hubble_h),\
                    np.log10(data[:,1])+_h_convertor_y(0.7,hubble_h),\
                    yerr=[np.log10(data[:,1])-np.log10(data[:,3]),\
                          np.log10(data[:,2])-np.log10(data[:,1])],\
                    markersize=markersize,fmt='^',color=color)


def plot_obsGSMF_z6pt0(ax,hubble_h=0.678,markersize=10,legend=True,color='gray',alpha=1.0):
    ##This is  Maddie hack
    dat=pd.read_json('reduced_data/duncan2014_z6.json',orient='split')
    ax.errorbar(dat['logM'],dat['phi'],yerr=[dat['dphi_lo'],dat['dphi_up']],markersize=markersize,fmt='s',color=color,label='Duncan+14')
    dat=pd.read_json('reduced_data/song2015_z6.json',orient='split')
    ax.errorbar(dat['logM'],dat['phi'],yerr=[dat['dphi_lo'],dat['dphi_up']],markersize=markersize,fmt='o',color=color,label='Song+15')
    dat=pd.read_json('reduced_data/gonzalez2011_z6.json',orient='split')
    ax.errorbar(dat['logM'],dat['phi'],yerr=[dat['dphi_lo'],dat['dphi_up']],markersize=markersize,fmt='D',color=color,label='Gonzalez+11')
    dat=pd.read_json('reduced_data/grazian2015_z6.json',orient='split')
    ax.errorbar(dat['logM'],dat['phi'],yerr=[dat['dphi_lo'],dat['dphi_up']],markersize=markersize,fmt='^',color=color,label='Grazian+15')
    dat=pd.read_json('reduced_data/spitler2017_5.50z6.50.json',orient='split')
    ax.errorbar(dat['logM'],dat['phi'],yerr=[dat['dphi_lo'],dat['dphi_up']],markersize=markersize,fmt='p',color=color,label='Spitler+17')

def plot_obsGSMF_z5pt0(ax,hubble_h=0.678,markersize=10,legend=True,color='gray',alpha=1.0):
    ...
    if legend:
        ax.errorbar(data[:,0]+_h_convertor_x(0.7,hubble_h),\
                    ...
                    markersize=markersize,fmt='p',color=color,mfc='None',\
    ...
    if legend:
        ax.plot(x+np.log10(Cha2Sal)+_h_convertor_x(0.7,hubble_h),\
        ...
        ax.plot(x+np.log10(Cha2Sal)+_h_convertor_x(0.7,hubble_h),\
                np.log10(y)+_h_convertor_y(0.7,hubble_h),\
                color=color,linestyle=':',lw=2,alpha=1)

def plot_obsGSMF_z4pt0(ax,hubble_h=0.678,markersize=10,legend=True,color='gray',alpha=1.0):
    ...
    #            np.log10(y)+_h_convertor_y(0.7,hubble_h),\
    #            color=color,linestyle='--',lw=5,label='Santini et al. 2012',alpha=1)
    #else:
    #    ax.plot(x+_h_convertor_x(0.7,hubble_h),\
    #            np.log10(y)+_h_convertor_y(0.7,hubble_h),\
    #            color=color,linestyle='--',lw=5,alpha=1)
    

def plot_obsGSMF_z3pt0(ax,hubble_h=0.678,markersize=10,legend=True,color='gray',alpha=1.0):

    #Marchesini 09
    data = []
    file = '/home/yqin/dragons/data/smf_Marchesini2009_z3pt5.dat'
    for line in open(file,'r'):  data.append(line.split())
    data = np.array(data[3:],dtype=np.float)
    ...
    if legend:
        ax.errorbar(data[:,0]+_h_convertor_x(0.7,hubble_h),\
                    data[:,1]+_h_convertor_y(0.7,hubble_h),\
                    yerr=[data[:,3],data[:,2]],\
                    markersize=markersize,fmt='*',color=color,label='Marchesini et al. 2009')
    else:
        ax.errorbar(data[:,0]+_h_convertor_x(0.7,hubble_h),\
                    data[:,1]+_h_convertor_y(0.7,hubble_h),\
                    yerr=[data[:,3],data[:,2]],\
    ...
    # Mortlock 11
    data = []
    file = '/home/yqin/dragons/data/smf_Mortlock2011_z3pt25.dat'
    for line in open(file,'r'):  data.append(line.split())
    data = np.array(data[3:],dtype=np.float)
    if legend:
        ax.errorbar(data[:,0]+_h_convertor_x(0.7,hubble_h),\
                    data[:,1]+_h_convertor_y(0.7,hubble_h),\
                    yerr=data[:,2],\
                    markersize=markersize,fmt='.',color=color,label='Mortlock et al. 2011')
    else:
        ax.errorbar(data[:,0]+_h_convertor_x(0.7,hubble_h),\
                    data[:,1]+_h_convertor_y(0.7,hubble_h),\
                    yerr=data[:,2],\
    ...
    y = _Schechter(x, logM_star, alpha, phi_star)
    if legend:
        ax.plot(x+np.log10(Kro2Sal)+_h_convertor_x(0.7,hubble_h),\
                np.log10(y)+_h_convertor_y(0.7,hubble_h),\
                color=color,linestyle='-.',\
    ...
    # Tomczak 14 #z:2.5-3.0
    data = []
    file = '/home/yqin/dragons/programs/hydro/MFtomczak_z2pt75.dat'
    for line in open(file,'r'): data.append(line.split())
    data = np.array(data[1:],dtype=np.float)
    if legend:
        ax.errorbar(data[:,0]+np.log10(Cha2Sal)+_h_convertor_x(0.7,hubble_h),\
                    data[:,1]+_h_convertor_y(0.7,hubble_h),\
                    yerr=[data[:,2],data[:,3]],\
                    markersize=markersize,fmt='v',color=color,label='Tomczak et al. 2014')
    else:
        ax.errorbar(data[:,0]+np.log10(Cha2Sal)+_h_convertor_x(0.7,hubble_h),\
                    data[:,1]+_h_convertor_y(0.7,hubble_h),\
                    markersize=markersize,fmt='v',color=color)
   
    # Huertas-Company 16 #z:2.5-3.
    alpha = -0.74
    phi_star = 0.34e-3
    logM_star = 10.90
    M_star = 10**logM_star
...
def plot_obsGSMF_z2pt0(ax,hubble_h=0.678,markersize=10,legend=True,color='gray',alpha=1.0):
    ...
    #                data[:,1]+_h_convertor_y(0.7,hubble_h),\
    #                yerr=[data[:,2],data[:,3]],\
    #                markersize=markersize,fmt='>',color=color,label='Khostovan16_HbetaOIII')
    #else:
    #    ax.errorbar(data[:,0]+np.log10(Cha2Sal)+_h_convertor_x(0.7,hubble_h),\
    #                data[:,1]+_h_convertor_y(0.7,hubble_h),\
    #                yerr=[data[:,2],data[:,3]],\
    ...
    #                data[:,1]+_h_convertor_y(0.7,hubble_h),\
    #                yerr=[data[:,2],data[:,3]],\
    #                markersize=markersize,fmt='<',color=color,label='Khostovan16_OII')
    #else:
    #    ax.errorbar(data[:,0]+np.log10(Cha2Sal)+_h_convertor_x(0.7,hubble_h),\
    #                data[:,1]+_h_convertor_y(0.7,hubble_h),\
    #                yerr=[data[:,2],data[:,3]],\
...
def plot_obsGSMF_z1pt75(ax,hubble_h=0.678,markersize=10,legend=True,color='gray',alpha=1.0):
...
def plot_obsGSMF_z1pt3(ax,hubble_h=0.678,markersize=10,legend=True,color='gray',alpha=1.0):
...
def plot_obsGSMF_z0pt95(ax,hubble_h=0.678,markersize=10,legend=True,color='gray',alpha=1.0):
    ...
    if legend:
        ax.errorbar(data[:,2]+_h_convertor_x(0.7,hubble_h),\
                    data[:,7]+_h_convertor_y(0.7,hubble_h),\
                    yerr=data[:,8],\
                    markersize=markersize,fmt='x',color=color,label='Drory et al. 2009')
    else:
        ax.errorbar(data[:,2]+_h_convertor_x(0.7,hubble_h),\
                    data[:,7]+_h_convertor_y(0.7,hubble_h),\
                    yerr=data[:,8],\
                    markersize=markersize,fmt='x',color=color)
...
def plot_obsGSMF_z0pt55(ax,hubble_h=0.678,markersize=10,legend=True,color='gray',alpha=1.0):
...
def plot_obsGSMF_z0pt0(ax,hubble_h=0.678,markersize=10,legend=True,color='gray',alpha=1.0):
    ...
    if legend:
        ax.errorbar(data[:,0]+_h_convertor_x(1.0,hubble_h),\
                    np.log10(data[:,1])+_h_convertor_y(1.0,hubble_h),\
                    yerr=np.log10(data[:,1])-np.log10(data[:,1]-data[:,2]),\
                    markersize=markersize,fmt='v',color=color,mfc='None',label='Cole et al. 2001')
    else:
        ax.errorbar(data[:,0]+_h_convertor_x(1.0,hubble_h),\
                    np.log10(data[:,1])+_h_convertor_y(1.0,hubble_h),\
                    yerr=np.log10(data[:,1])-np.log10(data[:,1]-data[:,2]),\
                    markersize=markersize,fmt='v',color=color,mfc='None')
    ...
    if legend:
        ax.errorbar(data[:,0]+_h_convertor_x(1.0,hubble_h),\
                    ...
                    markersize=markersize,fmt='^',color=color,mfc='None',label='Bell et al. 2003')
    else:
        ax.errorbar(data[:,0]+_h_convertor_x(1.0,hubble_h),\
                    np.log10(data[:,1])+_h_convertor_y(1.0,hubble_h),\
                    yerr=[np.log10(data[:,1])-np.log10(data[:,2]),\
                          np.log10(data[:,3])-np.log10(data[:,1])],
                    markersize=markersize,fmt='^',color=color,mfc='None')
    ...
    if legend:
        ax.errorbar(data[:,0]+_h_convertor_x(0.7,hubble_h),\
                    ...
                    markersize=markersize,fmt='s',color=color,mfc='None',label='Baldry et al. 2008')
    else:
        ax.errorbar(data[:,0]+_h_convertor_x(0.7,hubble_h),\
                    np.log10(data[:,2])+_h_convertor_y(0.7,hubble_h),\
                    yerr=[np.log10(data[:,2])-np.log10(data[:,4]),\
                          np.log10(data[:,5])-np.log10(data[:,2])],
                    markersize=markersize,fmt='s',color=color,mfc='None')
    ...
    if legend:
        ax.errorbar(data[:,0]+_h_convertor_x(0.7,hubble_h),\
                    data[:,1]+_h_convertor_y(0.7,hubble_h),\
                    yerr=[data[:,3],data[:,2]],\
                    markersize=markersize,fmt='v',color=color,mfc='None',label='Thanjavur et al. 2015')
    else:
        ax.errorbar(data[:,0]+_h_convertor_x(0.7,hubble_h),\
                    data[:,1]+_h_convertor_y(0.7,hubble_h),\
                    markersize=markersize,fmt='v',color=color,mfc='None')
...
def plot_obsGSMF_legend(ax,markersize=10,color='gray',alpha=1.0):
    ...
    x = np.linspace(10.0,12)
    y = _Schechter(x, logM_star, alpha, phi_star)
    ax.plot(x+np.log10(Cha2Sal),np.log10(y),color=color,linestyle='-',\
            lw=2,label='Pozzetti et al. 2007',alpha=1)
    ...
    x = np.linspace(9,13)
    y = _Schechter(x, logM_star, alpha, phi_star)
    ax.plot(x,np.log10(y),color=color,linestyle='--',lw=5,label='Santini et al. 2012',alpha=1)
    ...
    x = np.linspace(10.03,12)
    y = _Schechter(x, logM_star, alpha, phi_star)
    ax.plot(x+np.log10(Kro2Sal),np.log10(y),color=color,linestyle='-.',\
            lw=5,label='Muzzin et al. 2013',alpha=1)
...
def plot_obsGSMF(ax,z,hubble_h=0.678,markersize=10,legend=True,silent=False,color='gray',alpha=1.0):
    _plot_obsGSMF = {7.0:  plot_obsGSMF_z7pt0,\
                     6.0:  plot_obsGSMF_z6pt0,\
                     5.0:  plot_obsGSMF_z5pt0,\
                     4.0:  plot_obsGSMF_z4pt0,\
                     3.0:  plot_obsGSMF_z3pt0,\
    ...
    try:
        (_plot_obsGSMF[z])(ax, hubble_h=hubble_h,markersize=markersize,legend=legend,color=color,alpha=alpha)
    except:
        if not silent:
