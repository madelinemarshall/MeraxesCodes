...
def plot_MBHMstellar(filename,snapshots,mass_bulge,split,bulge_type,contours,color,axes):
  ...
  for snap in snapshots:
    ...
    axes.plot([9.5,11.6],inter+sl*np.array([9.5,11.6]),color=color,lw=2.5,label='$z=0$ (Tiamat-125-HR)')
...
if __name__=='__main__':
  ...
  filename_125='paper1_T125_false_eta_0p4_2'
  filename_def='dragons10_T125'
  ...
  if plot_type==1: 
    ...
    if z0:
      plot_MBHMstellar(filename_125,[250],True,split,bulge_type,contour,'gray',ax[0])
      plot_MBHMstellar(filename_125,[250],False,split,bulge_type,contour,'gray',ax[1])
      plot_MBHMstellar(filename_def,[250],True,split,bulge_type,contour,'r',ax[0])
      plot_MBHMstellar(filename_def,[250],False,split,bulge_type,contour,'r',ax[1])
