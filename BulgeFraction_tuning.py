...
if __name__=="__main__":
  ...
  for snapshot in [250]:
    ...
    if plot_mags:
      ...
      plot_disk_frac(gals_bulges,axes_frac[0,1],r'$r<17.77$ - ',0,bulge_frac,0)
      plot_disk_frac(gals_bulges,axes_frac[0,2],r'$r<19.8$ - ',0,bulge_frac,0)
  ...
  plt.savefig('/home/mmarshal/results/plots/tuning_paper2/BulgeFrac_{}.pdf'.format(int(meraxes_loc[-8:-5])),format='pdf')
  plt.show()
