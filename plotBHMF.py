...
if __name__=="__main__":
  ...
  #filename_default='bulges_noreion_fix'
  filename='tune'
  ...
  #plt.tight_layout()
  plt.savefig('/home/mmarshal/data_dragons/tune_refined/plots/BHMF_'+str(sys.argv[2])+'.pdf',format='pdf',bbox_extra_artists=(lgd,), bbox_inches='tight')
