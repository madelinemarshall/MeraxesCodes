...
color=['#ff7f00','#4daf4a','#984ea3','#377eb8','#e41a1c']#,\'#377eb8'
...
def plot_disk_frac_SDSS(axes,bulge_frac):
  ...
  if bulge_frac:
    ...
    axes.plot(M,F,'-.',label='Thanjavur et al. (2016)',color=color[3],lw=1.5)
...
def plot_bulge_frac_GAMMA(axes,bulge_frac):
  ...
  if bulge_frac:
    axes.errorbar(M,F,yerr=[F-F_low,F_up-F],marker='o',label='Moffett et al. (2016)',color='k',linestyle='')
...
if __name__=="__main__":
  ...
  #plot_bulge_frac_GAMMA(axes_frac,bulge_frac)
