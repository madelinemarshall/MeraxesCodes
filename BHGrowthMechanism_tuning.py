...
if __name__=="__main__":
  ...
  ii=-1
  for snapshot in [78,100,116,158]:
    ii+=1
  ...
  plt.savefig('/home/mmarshal/results/plots/tuning_paper2/Tiamat/BHGrowthModes_{}.pdf'.format(int(meraxes_loc[-8:-5])),format='pdf',bbox_extra_artists=(lgd,), bbox_inches='tight')
  plt.show()
