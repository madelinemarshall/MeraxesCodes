...
def plot_MBHMstellar(filename,snapshots,mass_bulge,split,bulge_type,axes,cbar=False):
  ...
  for snap in snapshots:
    gals=load_data(filename,snap,cosmo)
...
if __name__=='__main__':
  ...
  ax[3].axis('off')
  plt.tight_layout()
  plt.savefig('/home/mmarshal/results/plots/tuning_paper2/Tiamat/BHBR_{}.pdf'.format(int(meraxes_loc[-8:-5])),format='pdf',bbox_extra_artists=(lgd,), bbox_inches='tight')
  plt.show()
