...
def plot_MBHMstellar(filename,snapshots,mass_bulge,color,axes):
  ...
  for snap in snapshots:
    ...
    cp.contour_plot(logMstel_bulge,logMBH_bulge,xlab=None,ylab=None,xlims=[8,11.6],ylims=[6,9.2],axes=axes,colors='#e41a1c',linewidth=0.9)
    cp.contour_plot(logMstel_disk,logMBH_disk,xlab=None,ylab=None,xlims=[8,11.6],ylims=[6,9.2],axes=axes,colors='#377eb8',linewidth=0.9)#levels=np.logspace(-2,1,7)
    ii+=1
...
if __name__=='__main__':
  ...
  plt.tight_layout()
  plt.savefig('/home/mmarshal/results/plots/MBHMStellarRelation_BT.pdf', format='pdf')
  plt.show()
