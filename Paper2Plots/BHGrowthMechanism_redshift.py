...
if __name__=="__main__":
  ...
  filenames=['paper2']#'tuned_reion_T125','tuned_T125_MR','tuned_T125_NR','tuned_reion']
  ...
  plt.tight_layout()
  plt.savefig('/home/mmarshal/results/plots/Paper2/BHGrowthModes_redshift.pdf',format='pdf',bbox_extra_artists=(lgd,), bbox_inches='tight')
  plt.show()
