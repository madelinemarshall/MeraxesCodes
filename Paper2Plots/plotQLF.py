...
if __name__=="__main__":
  ...
  #for snapshot in [78,116,158,213]:
    ...
    axes[ii].text(-23.5, -5.4, r'$z={}$'.format(redshift[snapshot]),weight='bold',size='large')
...
##XRAY
  ...
  for snapshot in [100,116,134,158]:
    ...
    calculateQLF(gals_bulges,fname_1,'hardX',axesX[ii],eta=0.06,**{'linestyle':'-','label':'M18 Model','linewidth':2,'color':'k','zorder':100})
    calculateQLF(gals_default,fname_d,'hardX',axesX[ii],eta=0.06,**{'linestyle':'--','label':'Q17 Meraxes','linewidth':2,'color':'gray','zorder':102})
