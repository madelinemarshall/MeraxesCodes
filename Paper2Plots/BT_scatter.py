...
def plot_MBHMstellar(filename,snapshots,mass_bulge,color,axes):
  ...
  for snap in snapshots:
    gals=load_data(filename,snap,['GhostFlag','Mvir','StellarMass','BlackHoleMass','CentralGal','BulgeStellarMass'],centrals=True)
    ...
    axes.plot(logMstel_bulge,logMBH_bulge,'.',color='#e41a1c')
...
if __name__=='__main__':
  ...
  plt.tight_layout()
  plt.savefig('/home/mmarshal/results/plots/Paper2/MBHMStellarRelation_BT_scatter.pdf', format='pdf')
  plt.show()
